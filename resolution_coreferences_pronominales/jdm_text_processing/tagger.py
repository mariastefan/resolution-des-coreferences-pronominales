...
from resolution_coreferences_pronominales.jdm_text_processing.sort_pos_sequences import pos_sequences_out_path
sys.path.append(".")
...
import re
import json
from resolution_coreferences_pronominales.jdm_text_processing.tokenizer import tokenizer
